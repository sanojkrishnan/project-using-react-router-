...
const testFn = () => {
  //this is a test function to study dynamic imports
...
const isLoggedIn = () => {
  ...
  try {
    //used try catch to avoid errors if the local storage item is giving any issues // if there is an issue it will also return as not logged in or false
